...
public class GifView extends View {
    ...
    private static final int DEFAULT_MOVIEW_DURATION = 20000;
    private static final int SLOWER_BY_TIMES = 1;
    ...
    private void updateAnimationTime() {
        long now = android.os.SystemClock.uptimeMillis()/SLOWER_BY_TIMES;
     ...
     //   mCurrentAnimationTime = (int) ((now - mMovieStart) );   //remove looping
    }
    ...
    private void drawMovieFrame(Canvas canvas) {
       ...
       mMovie.setTime(mCurrentAnimationTime);
        //mMovie.setTime(DEFAULT_MOVIEW_DURATION);
